...
def generate_launch_description():
    nodes = [
        ...
        #     respawn=True,
        #     remappings=[
        #         ('camera', 'tello/image_raw')
        #     ],
        #     arguments=['~/tello_MD/wrk_src/tello-ros2/libs/ORB_SLAM2/Vocabulary/ORBvoc.txt', '~/tello_MD/wrk_src/tello-ros2/slam/src/orbslam2/config.yaml']
        # ),
